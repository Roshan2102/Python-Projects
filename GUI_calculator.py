'''
The task to implement a calculator using Tkinter that can be used to perform arithmetic operations.
'''
from tkinter import *
...
def input1(event):
    ...
    if text == "=":  # WHen = is pressed evaluate all the operations
        ...
        try:
            ...
            newstring = fullstring.replace(
                fullstring[-1], "")  # Remove last digit
...
root.title("ROSHAN Calculator")
root.wm_iconbitmap('calculator_22175.ico')
value = StringVar()
